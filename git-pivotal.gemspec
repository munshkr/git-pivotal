...
Gem::Specification.new do |s|
  ...
  s.executables = ["git-pivotal-finish", "git-pivotal-pick", "git-pivotal-chore", "git-pivotal-bug", "git-pivotal-feature", "git-pivotal"]
  s.extra_rdoc_files = [
    "LICENSE",
    "TODO"
  ]
  s.files = [
    ...
    "bin/git-pivotal",
    "bin/git-pivotal-bug",
    "bin/git-pivotal-chore",
    "bin/git-pivotal-feature",
    "bin/git-pivotal-finish",
    "bin/git-pivotal-pick",
    "git-pivotal.gemspec",
